...
{
    public static class ViewRegKeys
    {
        public const string AccountManagerMainView = "AccountManagerMainView";
        public const string BusinessOverview = "BusinessOverview";
        public const string ClientPaymentOverview = "ClientPaymentOverview";
        public const string ClientPaymentHistory = "ClientPaymentHistory";
        public const string EmailTemplateOverview = "EmailTemplateOverview";
        public const string LoginView = "LoginView";
        public const string MainView = "MainView";
        public const string MenuTopBar = "MenuTopBar";
        public const string OwnerOverview = "OwnerOverview";
        public const string PayrollOverview = "PayrollOverview";
        public const string PayrollYearEndOverview = "PayrollYearEndOverview";
        ...
        public const string WorkManager = "WorkManager";
    }
}
