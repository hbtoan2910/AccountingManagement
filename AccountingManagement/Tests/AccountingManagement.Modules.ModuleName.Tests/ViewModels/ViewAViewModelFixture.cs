//using AccountingManagement.Modules.ModuleName.ViewModels;
//using AccountingManagement.Services.Interfaces;
//using Moq;
//using Prism.Regions;
//using Xunit;

//namespace AccountingManagement.Modules.ModuleName.Tests.ViewModels
//{
